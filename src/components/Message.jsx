...
import { FiMessageCircle, FiUpload, FiHeart, FiRefreshCw, FiX } from "react-icons/fi"
...
const Message = ({ message }) => {
  ...
  useEffect(() => {
    if(user) {
      const hasLike = message.likes.some(like => like.likeBy.id === user.uid)
      setIsLike(hasLike)
    }
  }, [user, message.likes])
  ...
  return (
    <div className='message-container'>
      <div>
          <img 
            src={message.photo === "https://graph.facebook.com/103490365080806/picture" ? require("../images/circle-cropped.png") : message.photo}
            alt='Profil' 
